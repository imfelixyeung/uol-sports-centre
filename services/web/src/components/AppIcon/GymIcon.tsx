// modified from http://map-icons.com/
// original https://github.com/scottdejonge/map-icons/blob/master/src/icons/gym.svg

import type {FC, HTMLAttributes} from 'react';

type GymIconProps = HTMLAttributes<SVGElement>;

const GymIcon: FC<GymIconProps> = props => {
  return (
    <svg
      version="1.2"
      baseProfile="tiny"
